...
도커에 대한 간략 소개는 아래 동영상 참조:

* [도커 소개](https://www.youtube.com/watch?v=ufLmReluPww)

윈도우 10에서 도커 이미지를 활용한 개발환경 설정법은 아래 설명 참조

* [윈도우 10에서 도커 + VS Code 사용법](./개발환경설정.md)

주피터 노트북의 간단한 사용법은 아래 동영상 참조
